...
export default function Home() {
  return (
    <div className={`bg-black text-white h-screen flex flex-col justify-center items-center ${inter.className}`}>
      ...
      <div className='text-[82px] text-center font-semibold w-[1152px] flex' >
        <div className='text-[#24FF00] pr-[10px]'>Connect</div>
        <div>with friends and </div>
      </div>
      <div className='text-[82px] text-center font-semibold w-[1152px] flex'>loved ones effortlessly.</div>
    </div>
  )
}
